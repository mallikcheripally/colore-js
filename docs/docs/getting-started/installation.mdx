...
id: installation
title: Installation
description: 'Install Colore JS effortlessly with our detailed guide. Learn how to set up this powerful JavaScript and TypeScript color manipulation library using npm or yarn. Get started now!'
keywords:
  - colore-js
  - colore
  - colore js
