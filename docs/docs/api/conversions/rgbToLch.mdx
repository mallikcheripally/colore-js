...
id: rgbToLch
title: rgbToLch
description: "Learn how to use the rgbToLch function in Colore JS to convert RGB color values to LCH format. This guide includes the syntax, parameters, examples, and practical applications for converting RGB colors to LCH in your projects."
keywords:
  - colore-js
  - colore
  - colore js
