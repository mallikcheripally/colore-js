...
id: parseRgb
title: parseRgb
description: "Learn how to use the parseRgb function in Colore JS to parse and convert RGB color values. This guide covers the syntax, parameters, examples, and practical applications for working with RGB colors in your projects."
keywords:
  - colore-js
  - colore
  - colore js
