...
description: "Learn how to use the decomposeColor function in Colore JS to break down a color into its component parts. This guide covers the syntax, parameters, examples, and practical applications for color decomposition in your projects."
keywords:
  - colore-js
  - colore
  - colore js
